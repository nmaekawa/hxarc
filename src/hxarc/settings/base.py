...
# obscure admin ui a bit
HXARC_ADMIN_URL_PATH = os.environ.get("HXYDRA_ADMIN_URL_PATH", "admin/")
# redefine login to admin login
LOGIN_URL = "/{}/login/".format(HXARC_ADMIN_URL_PATH)
